const STEPS = [
  {
    step: "1",
    title: "Install",
    description: "One command. Works with any Node.js project. No config needed.",
    code: "npx vibecheck init ./my-app",
    color: "var(--color-accent-blue)",
  },
  {
    step: "2",
    title: "Scan",
    description: "Static analysis + LLM judges find defects across 7 dimensions.",
    code: "npx vibecheck scan --llm",
    color: "var(--color-accent-green)",
  },
  {
    step: "3",
    title: "Ship",
    description: "Autonomous fixes, gate verification, and production-ready code.",
